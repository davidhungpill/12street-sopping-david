        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="productDeliveries"
                        to="/deliveryManagements/productDeliveries"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        ...
                        to="/inventoryManagements/inventoryManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'productDeliveries', 
                route: '/deliveryManagements/productDeliveries',
                ImageUrl: '',
            },
            { 
                ...
                description: '', 
                key: 'inventoryManagements', 
                route: '/inventoryManagements/inventoryManagements',
                ImageUrl: '',
            },
            { 
                title: 'Message', 
