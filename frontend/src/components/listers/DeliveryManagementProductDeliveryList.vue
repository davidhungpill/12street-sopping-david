        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <DeliveryManagementProductDelivery :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
