...
<script>
    ...
    export default {
        name: 'DeliveryManagementProductDeliveryPicker',
        props: {
        ...
        async created() {
            ...
            if(temp.data) {
                me.list = temp.data._embedded.productDeliveries;
            }

            if(me.value && typeof me.value == "object" && Object.values(me.value)[0]) {
                var id = Object.values(me.value)[0];
                var tmpValue = await axios.get(axios.fixUrl('/productDeliveries/' + id))
                if(tmpValue.data) {
