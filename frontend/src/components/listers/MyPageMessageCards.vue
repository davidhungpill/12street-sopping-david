    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex">
                    ...
                    <h1 class="align-self-center ml-3">Message</h1>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <MyPageMessage :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <MyPageMessage :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import MyPageMessage from './../MyPageMessage.vue';
